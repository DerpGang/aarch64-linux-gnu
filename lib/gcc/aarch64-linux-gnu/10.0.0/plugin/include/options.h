...
enum opt_code
{
  ...
  OPT_defined_only = 495,                    /* -defined-only */
  OPT_demangle = 496,                        /* -demangle */
  OPT_dstartfiles = 497,                     /* -dstartfiles */
  OPT_dump_body_ = 498,                      /* -dump-body= */
  OPT_dump_level_ = 499,                     /* -dump-level= */
  OPT_dumpbase = 500,                        /* -dumpbase */
  OPT_dumpdir = 501,                         /* -dumpdir */
  OPT_dumpfullversion = 502,                 /* -dumpfullversion */
  OPT_dumpmachine = 503,                     /* -dumpmachine */
  OPT_dumpspecs = 504,                       /* -dumpspecs */
  OPT_dumpversion = 505,                     /* -dumpversion */
  OPT_e = 506,                               /* -e */
  OPT_export_dynamic = 507,                  /* -export-dynamic */
  OPT_fPIC = 508,                            /* -fPIC */
  OPT_fPIE = 509,                            /* -fPIE */
  OPT_fRTS_ = 510,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 511,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 512,                   /* -fabi-version= */
  OPT_faccess_control = 513,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 514,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 515,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 516,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 517,                  /* -falign-commons */
  OPT_falign_functions = 518,                /* -falign-functions */
  OPT_falign_functions_ = 519,               /* -falign-functions= */
  OPT_falign_jumps = 520,                    /* -falign-jumps */
  OPT_falign_jumps_ = 521,                   /* -falign-jumps= */
  OPT_falign_labels = 522,                   /* -falign-labels */
  OPT_falign_labels_ = 523,                  /* -falign-labels= */
  OPT_falign_loops = 524,                    /* -falign-loops */
  OPT_falign_loops_ = 525,                   /* -falign-loops= */
  /* OPT_faligned_new = 526, */              /* -faligned-new */
  OPT_faligned_new_ = 527,                   /* -faligned-new= */
  OPT_fall_instantiations = 528,             /* -fall-instantiations */
  OPT_fall_intrinsics = 529,                 /* -fall-intrinsics */
  OPT_fall_virtual = 530,                    /* -fall-virtual */
  OPT_fallow_leading_underscore = 531,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 532,/* -fallow-parameterless-variadic-functions */
  OPT_falt_external_templates = 533,         /* -falt-external-templates */
  /* OPT_fargument_alias = 534, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 535, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 536, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 537, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 538,            /* -fasan-shadow-offset= */
  OPT_fasm = 539,                            /* -fasm */
  OPT_fassert = 540,                         /* -fassert */
  OPT_fassociative_math = 541,               /* -fassociative-math */
  OPT_fassume_phsa = 542,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 543,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 544,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 545,                   /* -fauto-profile */
  OPT_fauto_profile_ = 546,                  /* -fauto-profile= */
  OPT_fautomatic = 547,                      /* -fautomatic */
  OPT_fbackslash = 548,                      /* -fbackslash */
  OPT_fbacktrace = 549,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 550,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 551,                   /* -fbounds-check */
  OPT_fbounds_check_ = 552,                  /* -fbounds-check= */
  ...
  OPT_fbuilding_libphobos_tests = 559,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 560,                        /* -fbuiltin */
  OPT_fbuiltin_ = 561,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 562,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 563,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 564,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 565,                    /* -fcall-saved- */
  OPT_fcall_used_ = 566,                     /* -fcall-used- */
  OPT_fcaller_saves = 567,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 568,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 569, */            /* -fcf-protection */
  OPT_fcf_protection_ = 570,                 /* -fcf-protection= */
  OPT_fchar8_t = 571,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 572,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 573, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 574,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 575,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 576,                         /* -fcheck= */
  OPT_fchecking = 577,                       /* -fchecking */
  OPT_fchecking_ = 578,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 579,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 580,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 581,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 582,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 583,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 584,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 585,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 586,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 587, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 588,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 589,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 590,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 591, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 592,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 593,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 594,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 595,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 596,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 597, */                 /* -fcilkplus */
  OPT_fcoarray_ = 598,                       /* -fcoarray= */
  OPT_fcode_hoisting = 599,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 600,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 601,                         /* -fcommon */
  OPT_fcompare_debug = 602,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 603,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 604,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 605,                   /* -fcompare-elim */
  OPT_fconcepts = 606,                       /* -fconcepts */
  OPT_fcond_mismatch = 607,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 608, */           /* -fconserve-space */
  OPT_fconserve_stack = 609,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 610,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 611,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 612,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 613,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 614,                       /* -fconvert= */
  OPT_fcprop_registers = 615,                /* -fcprop-registers */
  OPT_fcray_pointer = 616,                   /* -fcray-pointer */
  OPT_fcrossjumping = 617,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 618,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 619, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 620,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 621,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 622,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 623,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 624,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 625,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 626,                       /* -fdbg-cnt= */
  OPT_fdce = 627,                            /* -fdce */
  OPT_fdebug = 628,                          /* -fdebug */
  OPT_fdebug_cpp = 629,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 630,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 631,            /* -fdebug-types-section */
  OPT_fdebug_ = 632,                         /* -fdebug= */
  OPT_fdec = 633,                            /* -fdec */
  OPT_fdec_include = 634,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 635,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 636,                       /* -fdec-math */
  OPT_fdec_static = 637,                     /* -fdec-static */
  OPT_fdec_structure = 638,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 639,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 640,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 641,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 642, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 643,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 644,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 645,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 646,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 647,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 648,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 649,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 650,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 651,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 652,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 653,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 654, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 655,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 656,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 657,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 658,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 659,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 660,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_labels = 661,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 662,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 663,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 664,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 665, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 666,                /* -fdirectives-only */
  OPT_fdisable_ = 667,                       /* -fdisable- */
  OPT_fdoc = 668,                            /* -fdoc */
  OPT_fdoc_dir_ = 669,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 670,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 671,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 672,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 673,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 674,                       /* -fdruntime */
  OPT_fdse = 675,                            /* -fdse */
  OPT_fdump_ = 676,                          /* -fdump- */
  OPT_fdump_ada_spec = 677,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 678,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 679, */                /* -fdump-core */
  OPT_fdump_d_original = 680,                /* -fdump-d-original */
  OPT_fdump_final_insns = 681,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 682,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 683,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 684,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 685,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 686,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 687,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 688, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 689,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 690,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 691,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 692,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 693,                 /* -fearly-inlining */
  OPT_felide_constructors = 694,             /* -felide-constructors */
  OPT_felide_type = 695,                     /* -felide-type */
  ...
  OPT_femit_struct_debug_baseonly = 700,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 701,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 702,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 703,                        /* -fenable- */
  OPT_fenforce_eh_specs = 704,               /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 705,                 /* -fenum-int-equiv */
  OPT_fexceptions = 706,                     /* -fexceptions */
  OPT_fexcess_precision_ = 707,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 708,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 709,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 710,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 711,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 712,                /* -fextern-tls-init */
  OPT_fexternal_blas = 713,                  /* -fexternal-blas */
  OPT_fexternal_templates = 714,             /* -fexternal-templates */
  OPT_ff2c = 715,                            /* -ff2c */
  OPT_ffast_math = 716,                      /* -ffast-math */
  OPT_ffat_lto_objects = 717,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 718,               /* -ffile-prefix-map= */
  OPT_ffinite_math_only = 719,               /* -ffinite-math-only */
  OPT_ffixed_ = 720,                         /* -ffixed- */
  OPT_ffixed_form = 721,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 722,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 723,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 724,                    /* -ffloat-store */
  OPT_ffor_scope = 725,                      /* -ffor-scope */
  /* OPT_fforce_addr = 726, */               /* -fforce-addr */
  OPT_fforward_propagate = 727,              /* -fforward-propagate */
  OPT_ffp_contract_ = 728,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 729,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 730,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 731,                      /* -ffpe-trap= */
  OPT_ffree_form = 732,                      /* -ffree-form */
  OPT_ffree_line_length_ = 733,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 734,          /* -ffree-line-length-none */
  OPT_ffreestanding = 735,                   /* -ffreestanding */
  OPT_ffriend_injection = 736,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 737,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 738,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 739,                   /* -ffunction-cse */
  OPT_ffunction_sections = 740,              /* -ffunction-sections */
  OPT_fgcse = 741,                           /* -fgcse */
  OPT_fgcse_after_reload = 742,              /* -fgcse-after-reload */
  OPT_fgcse_las = 743,                       /* -fgcse-las */
  OPT_fgcse_lm = 744,                        /* -fgcse-lm */
  OPT_fgcse_sm = 745,                        /* -fgcse-sm */
  OPT_fgimple = 746,                         /* -fgimple */
  OPT_fgnat_encodings_ = 747,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 748,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 749,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 750,                         /* -fgnu-tm */
  OPT_fgnu_unique = 751,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 752,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 753,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 754,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 755,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 756,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 757,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 758,          /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 759,          /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 760,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 761,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 762,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 763,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 764,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 765,                       /* -fgraphite */
  OPT_fgraphite_identity = 766,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 767,       /* -fguess-branch-probability */
  OPT_fguiding_decls = 768,                  /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 769, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 770, */                     /* -fhelp */
  /* OPT_fhelp_ = 771, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 772,           /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 773,                      /* -fhonor-std */
  OPT_fhosted = 774,                         /* -fhosted */
  OPT_fhuge_objects = 775,                   /* -fhuge-objects */
  OPT_fident = 776,                          /* -fident */
  OPT_fif_conversion = 777,                  /* -fif-conversion */
  OPT_fif_conversion2 = 778,                 /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 779,         /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 780,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 781,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 782,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 783,             /* -fimplicit-templates */
  OPT_findirect_inlining = 784,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 785,         /* -finhibit-size-directive */
  OPT_finit_character_ = 786,                /* -finit-character= */
  OPT_finit_derived = 787,                   /* -finit-derived */
  OPT_finit_integer_ = 788,                  /* -finit-integer= */
  OPT_finit_local_zero = 789,                /* -finit-local-zero */
  OPT_finit_logical_ = 790,                  /* -finit-logical= */
  OPT_finit_real_ = 791,                     /* -finit-real= */
  OPT_finline = 792,                         /* -finline */
  OPT_finline_atomics = 793,                 /* -finline-atomics */
  OPT_finline_functions = 794,               /* -finline-functions */
  OPT_finline_functions_called_once = 795,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 796, */            /* -finline-limit- */
  OPT_finline_limit_ = 797,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 798,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 799,         /* -finline-small-functions */
  OPT_finput_charset_ = 800,                 /* -finput-charset= */
  OPT_finstrument_functions = 801,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 802,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 803,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 804,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 805,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 806,        /* -fintrinsic-modules-path= */
  OPT_finvariants = 807,                     /* -finvariants */
  OPT_fipa_bit_cp = 808,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 809,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 810, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 811,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 812,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 813,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 814,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 815, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 816,                    /* -fipa-profile */
  OPT_fipa_pta = 817,                        /* -fipa-pta */
  OPT_fipa_pure_const = 818,                 /* -fipa-pure-const */
  OPT_fipa_ra = 819,                         /* -fipa-ra */
  OPT_fipa_reference = 820,                  /* -fipa-reference */
  OPT_fipa_reference_addressable = 821,      /* -fipa-reference-addressable */
  OPT_fipa_sra = 822,                        /* -fipa-sra */
  OPT_fipa_stack_alignment = 823,            /* -fipa-stack-alignment */
  ...
  OPT_flax_vector_conversions = 844,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 845,             /* -fleading-underscore */
  OPT_flifetime_dse = 846,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 847,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 848,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 849,                 /* -flinker-output= */
  /* OPT_flive_patching = 850, */            /* -flive-patching */
  OPT_flive_patching_ = 851,                 /* -flive-patching= */
  OPT_flive_range_shrinkage = 852,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 853,                    /* -flocal-ivars */
  /* OPT_floop_block = 854, */               /* -floop-block */
  /* OPT_floop_flatten = 855, */             /* -floop-flatten */
  OPT_floop_interchange = 856,               /* -floop-interchange */
  OPT_floop_nest_optimize = 857,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 858, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 859,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 860, */          /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 861,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 862,                      /* -flra-remat */
  OPT_flto = 863,                            /* -flto */
  OPT_flto_compression_level_ = 864,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 865,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 866,                 /* -flto-partition= */
  OPT_flto_report = 867,                     /* -flto-report */
  OPT_flto_report_wpa = 868,                 /* -flto-report-wpa */
  OPT_flto_ = 869,                           /* -flto= */
  OPT_fltrans = 870,                         /* -fltrans */
  OPT_fltrans_output_list_ = 871,            /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 872,              /* -fmacro-prefix-map= */
  OPT_fmain = 873,                           /* -fmain */
  OPT_fmath_errno = 874,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 875,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 876,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 877,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 878,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 879,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 880,                     /* -fmem-report */
  OPT_fmem_report_wpa = 881,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 882,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 883,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 884,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 885,                /* -fmessage-length= */
  OPT_fmodule_file_ = 886,                   /* -fmodule-file= */
  OPT_fmodule_private = 887,                 /* -fmodule-private */
  OPT_fmoduleinfo = 888,                     /* -fmoduleinfo */
  OPT_fmodulo_sched = 889,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 890,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 891,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 892,                  /* -fms-extensions */
  OPT_fmudflap = 893,                        /* -fmudflap */
  OPT_fmudflapir = 894,                      /* -fmudflapir */
  OPT_fmudflapth = 895,                      /* -fmudflapth */
  OPT_fname_mangling_version_ = 896,         /* -fname-mangling-version- */
  OPT_fnew_abi = 897,                        /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 898,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 899,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 900,                   /* -fnext-runtime */
  OPT_fnil_receivers = 901,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 902,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 903,               /* -fnonansi-builtins */
  OPT_fnonnull_objects = 904,                /* -fnonnull-objects */
  OPT_fnothrow_opt = 905,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 906,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 907,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 908,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 909,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 910,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 911,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 912,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 913,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 914,                   /* -foffload-abi= */
  OPT_foffload_ = 915,                       /* -foffload= */
  OPT_fomit_frame_pointer = 916,             /* -fomit-frame-pointer */
  OPT_fonly_ = 917,                          /* -fonly= */
  OPT_fopenacc = 918,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 919,                   /* -fopenacc-dim= */
  OPT_fopenmp = 920,                         /* -fopenmp */
  OPT_fopenmp_simd = 921,                    /* -fopenmp-simd */
  OPT_foperator_names = 922,                 /* -foperator-names */
  OPT_fopt_info = 923,                       /* -fopt-info */
  OPT_fopt_info_ = 924,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 925, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 926,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 927,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 928, */           /* -foptional-diags */
  OPT_fpack_derived = 929,                   /* -fpack-derived */
  OPT_fpack_struct = 930,                    /* -fpack-struct */
  OPT_fpack_struct_ = 931,                   /* -fpack-struct= */
  OPT_fpad_source = 932,                     /* -fpad-source */
  OPT_fpartial_inlining = 933,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 934,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 935,              /* -fpcc-struct-return */
  OPT_fpch_deps = 936,                       /* -fpch-deps */
  OPT_fpch_preprocess = 937,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 938,                     /* -fpeel-loops */
  OPT_fpeephole = 939,                       /* -fpeephole */
  OPT_fpeephole2 = 940,                      /* -fpeephole2 */
  OPT_fpermissive = 941,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 942,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 943,                            /* -fpic */
  OPT_fpie = 944,                            /* -fpie */
  OPT_fplan9_extensions = 945,               /* -fplan9-extensions */
  OPT_fplt = 946,                            /* -fplt */
  OPT_fplugin_arg_ = 947,                    /* -fplugin-arg- */
  OPT_fplugin_ = 948,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 949,            /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 950,                 /* -fpostconditions */
  OPT_fpre_include_ = 951,                   /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 952,             /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 953,                  /* -fpreconditions */
  OPT_fpredictive_commoning = 954,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 955,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 956,                   /* -fpreprocessed */
  OPT_fpretty_templates = 957,               /* -fpretty-templates */
  OPT_fprintf_return_value = 958,            /* -fprintf-return-value */
  OPT_fprofile = 959,                        /* -fprofile */
  OPT_fprofile_abs_path = 960,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 961,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 962,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 963,                   /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 964,         /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 965,          /* -fprofile-filter-files= */
  OPT_fprofile_generate = 966,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 967,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 968,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 969,                 /* -fprofile-report */
  OPT_fprofile_update_ = 970,                /* -fprofile-update= */
  OPT_fprofile_use = 971,                    /* -fprofile-use */
  OPT_fprofile_use_ = 972,                   /* -fprofile-use= */
  OPT_fprofile_values = 973,                 /* -fprofile-values */
  OPT_fprotect_parens = 974,                 /* -fprotect-parens */
  OPT_frandom_seed = 975,                    /* -frandom-seed */
  OPT_frandom_seed_ = 976,                   /* -frandom-seed= */
  OPT_frange_check = 977,                    /* -frange-check */
  OPT_freal_4_real_10 = 978,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 979,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 980,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 981,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 982,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 983,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 984,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 985,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 986,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 987,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 988,                /* -frecord-marker=8 */
  OPT_frecursive = 989,                      /* -frecursive */
  OPT_free = 990,                            /* -free */
  OPT_freg_struct_return = 991,              /* -freg-struct-return */
  /* OPT_fregmove = 992, */                  /* -fregmove */
  OPT_frelease = 993,                        /* -frelease */
  OPT_frename_registers = 994,               /* -frename-registers */
  OPT_freorder_blocks = 995,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 996,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 997,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 998,              /* -freorder-functions */
  OPT_frepack_arrays = 999,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 1000,          /* -freplace-objc-classes */
  OPT_frepo = 1001,                          /* -frepo */
  OPT_freport_bug = 1002,                    /* -freport-bug */
  OPT_frequire_return_statement = 1003,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1004,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1005, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1006,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1007,                   /* -fresolution= */
  OPT_frounding_math = 1008,                 /* -frounding-math */
  OPT_frtti = 1009,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1010,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1011,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1012,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1013,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1014,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1015,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1016,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1017,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1018, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1019,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1020,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1021,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1022,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1023,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1024,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1025,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1026,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1027,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1028,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1029,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1030,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1031,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1032,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1033,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1034,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1035, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1036,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1037,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1038,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1039,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1040,               /* -fsection-anchors */
  /* OPT_fsee = 1041, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1042,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1043,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1044,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1045,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1046,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1047,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1048,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1049,                   /* -fshort-enums */
  OPT_fshort_wchar = 1050,                   /* -fshort-wchar */
  OPT_fshow_column = 1051,                   /* -fshow-column */
  OPT_fshrink_wrap = 1052,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1053,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1054,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1055,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1056,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1057,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1058,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1059,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1060,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1061,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1062,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1063,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1064,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1065,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1066,              /* -fsplit-wide-types */
  OPT_fsquangle = 1067,                      /* -fsquangle */
  OPT_fssa_backprop = 1068,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1069,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1070,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1071,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1072, */             /* -fstack-check */
  OPT_fstack_check_ = 1073,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1074,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1075,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1076,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1077,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1078,               /* -fstack-protector */
  OPT_fstack_protector_all = 1079,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1080,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1081,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1082,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1083,                   /* -fstack-usage */
  OPT_fstats = 1084,                         /* -fstats */
  OPT_fstdarg_opt = 1085,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1086,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1087, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1088,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1089,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1090,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1091,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1092,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1093, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1094,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1095,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1096,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1097,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1098,                      /* -ftabstop= */
  ...
  OPT_fxref = 1220,                          /* -fxref */
  /* OPT_fzee = 1221, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1222,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1223,                     /* -fzero-link */
  OPT_g = 1224,                              /* -g */
  OPT_gant = 1225,                           /* -gant */
  OPT_gas_loc_support = 1226,                /* -gas-loc-support */
  OPT_gas_locview_support = 1227,            /* -gas-locview-support */
  OPT_gcoff = 1228,                          /* -gcoff */
  OPT_gcoff1 = 1229,                         /* -gcoff1 */
  OPT_gcoff2 = 1230,                         /* -gcoff2 */
  OPT_gcoff3 = 1231,                         /* -gcoff3 */
  OPT_gcolumn_info = 1232,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1233,                 /* -gdescribe-dies */
  OPT_gdwarf = 1234,                         /* -gdwarf */
  OPT_gdwarf_ = 1235,                        /* -gdwarf- */
  OPT_gen_decls = 1236,                      /* -gen-decls */
  OPT_ggdb = 1237,                           /* -ggdb */
  OPT_ggnu_pubnames = 1238,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1239,                   /* -gimple-stats */
  ...
  OPT_h = 1261,                              /* -h */
  OPT_help = 1262,                           /* -help */
  OPT_idirafter = 1263,                      /* -idirafter */
  OPT_imacros = 1264,                        /* -imacros */
  OPT_imultiarch = 1265,                     /* -imultiarch */
  OPT_imultilib = 1266,                      /* -imultilib */
  OPT_include = 1267,                        /* -include */
  OPT_iplugindir_ = 1268,                    /* -iplugindir= */
  OPT_iprefix = 1269,                        /* -iprefix */
  OPT_iquote = 1270,                         /* -iquote */
  OPT_isysroot = 1271,                       /* -isysroot */
  OPT_isystem = 1272,                        /* -isystem */
  OPT_iwithprefix = 1273,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1274,              /* -iwithprefixbefore */
  OPT_k8 = 1275,                             /* -k8 */
  OPT_l = 1276,                              /* -l */
  OPT_lang_asm = 1277,                       /* -lang-asm */
  OPT_list = 1278,                           /* -list */
  OPT_mabi_ = 1279,                          /* -mabi= */
  OPT_march_ = 1280,                         /* -march= */
  OPT_mbig_endian = 1281,                    /* -mbig-endian */
  OPT_mbionic = 1282,                        /* -mbionic */
  OPT_mbranch_protection_ = 1283,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1284,                       /* -mcmodel= */
  OPT_mcpu_ = 1285,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1286,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1287,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1288,             /* -mgeneral-regs-only */
  OPT_mglibc = 1289,                         /* -mglibc */
  OPT_mlittle_endian = 1290,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1291,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1292,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1293,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1294,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1295,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1296,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1297,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1298,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1299, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1300,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1301,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1302,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1303,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1304,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1305,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1306,             /* -mtrack-speculation */
  OPT_mtune_ = 1307,                         /* -mtune= */
  OPT_muclibc = 1308,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1309,             /* -mverbose-cost-dump */
  OPT_n = 1310,                              /* -n */
  OPT_name_sort = 1311,                      /* -name-sort */
  ...
  OPT_nolibc = 1317,                         /* -nolibc */
  OPT_nophoboslib = 1318,                    /* -nophoboslib */
  OPT_nostartfiles = 1319,                   /* -nostartfiles */
  OPT_nostdinc = 1320,                       /* -nostdinc */
  OPT_nostdinc__ = 1321,                     /* -nostdinc++ */
  OPT_nostdlib = 1322,                       /* -nostdlib */
  OPT_o = 1323,                              /* -o */
  OPT_objects = 1324,                        /* -objects */
  OPT_p = 1325,                              /* -p */
  OPT_pass_exit_codes = 1326,                /* -pass-exit-codes */
  /* OPT_pedantic = 1327, */                 /* -pedantic */
  OPT_pedantic_errors = 1328,                /* -pedantic-errors */
  OPT_pg = 1329,                             /* -pg */
  OPT_pie = 1330,                            /* -pie */
  OPT_pipe = 1331,                           /* -pipe */
  OPT_posix = 1332,                          /* -posix */
  OPT_print_file_name_ = 1333,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1334,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1335,          /* -print-multi-directory */
  OPT_print_multi_lib = 1336,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1337,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1338,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1339,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1340,               /* -print-prog-name= */
  OPT_print_search_dirs = 1341,              /* -print-search-dirs */
  OPT_print_sysroot = 1342,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1343,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1344,                    /* -print-value */
  OPT_profile = 1345,                        /* -profile */
  OPT_pthread = 1346,                        /* -pthread */
  OPT_quiet = 1347,                          /* -quiet */
  OPT_r = 1348,                              /* -r */
  OPT_rdynamic = 1349,                       /* -rdynamic */
  OPT_remap = 1350,                          /* -remap */
  OPT_reverse_sort = 1351,                   /* -reverse-sort */
  OPT_s = 1352,                              /* -s */
  OPT_save_temps = 1353,                     /* -save-temps */
  OPT_save_temps_ = 1354,                    /* -save-temps= */
  OPT_shared = 1355,                         /* -shared */
  OPT_shared_libgcc = 1356,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1357,               /* -shared-libphobos */
  OPT_size_sort = 1358,                      /* -size-sort */
  ...
  OPT_static_libgfortran = 1364,             /* -static-libgfortran */
  OPT_static_libgo = 1365,                   /* -static-libgo */
  OPT_static_liblsan = 1366,                 /* -static-liblsan */
  OPT_static_libmpx = 1367,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1368,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1369,               /* -static-libphobos */
  OPT_static_libstdc__ = 1370,               /* -static-libstdc++ */
  OPT_static_libtsan = 1371,                 /* -static-libtsan */
  OPT_static_libubsan = 1372,                /* -static-libubsan */
  OPT_static_pie = 1373,                     /* -static-pie */
  /* OPT_std_c__03 = 1374, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1375, */                /* -std=c++0x */
  OPT_std_c__11 = 1376,                      /* -std=c++11 */
  OPT_std_c__14 = 1377,                      /* -std=c++14 */
  OPT_std_c__17 = 1378,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1379, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1380, */                /* -std=c++1z */
  OPT_std_c__2a = 1381,                      /* -std=c++2a */
  OPT_std_c__98 = 1382,                      /* -std=c++98 */
  OPT_std_c11 = 1383,                        /* -std=c11 */
  OPT_std_c17 = 1384,                        /* -std=c17 */
  /* OPT_std_c18 = 1385, */                  /* -std=c18 */
  /* OPT_std_c1x = 1386, */                  /* -std=c1x */
  OPT_std_c2x = 1387,                        /* -std=c2x */
  ...
  OPT_std_f2018 = 1395,                      /* -std=f2018 */
  OPT_std_f95 = 1396,                        /* -std=f95 */
  OPT_std_gnu = 1397,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1398, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1399, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1400,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1401,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1402,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1403, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1404, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1405,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1406,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1407,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1408,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1409, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1410, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1411,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1412, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1413,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1414,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1415, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1416, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1417,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1418, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1419, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1420, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1421, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1422, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1423,                     /* -std=legacy */
  OPT_symbol_ = 1424,                        /* -symbol= */
  OPT_symbolic = 1425,                       /* -symbolic */
  OPT_t = 1426,                              /* -t */
  OPT_time = 1427,                           /* -time */
  OPT_time_ = 1428,                          /* -time= */
  OPT_traditional = 1429,                    /* -traditional */
  OPT_traditional_cpp = 1430,                /* -traditional-cpp */
  OPT_tree_stats = 1431,                     /* -tree-stats */
  OPT_trigraphs = 1432,                      /* -trigraphs */
  OPT_type_stats = 1433,                     /* -type-stats */
  OPT_u = 1434,                              /* -u */
  OPT_undef = 1435,                          /* -undef */
  OPT_v = 1436,                              /* -v */
  OPT_version = 1437,                        /* -version */
  OPT_w = 1438,                              /* -w */
  OPT_wrapper = 1439,                        /* -wrapper */
  OPT_x = 1440,                              /* -x */
  OPT_z = 1441,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
